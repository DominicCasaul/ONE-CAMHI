...
<body>
    ...
    <div class="offcanvas offcanvas-end kulay" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions"
        ...
        <hr>
            ...
            <a href="/ONECAMHI-DIWATA/ONE-CAMHI-USB/HTMLPage/PageApproval.html.php"
                class="btn kulay float-none fw-bold text-white"> <img class="mx-2"
      ...
      <p class="text-center">
      Note: The posts that receive approval on this page will be displayed on the homepage.
      </p>
  ...
  <div class="container d-flex flex-column " id="TemplteContainer">
    <h1 class="text-center">No Post To Approve</h1>
  </div>
  ...
  <div class="container d-flex flex-column " id="TemplteContainer">
   ...
   <table id="post" class="table">
      ...
      <script src="../JS/jquery-min.js"></script>
        ...
        <script src="../JS/PageApproval.js"></script>
