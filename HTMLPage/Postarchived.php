...
<body>
    ...
    <div class="offcanvas offcanvas-end kulay" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions"
        ...
        <hr>
            ...
            class="btn kulay text-white float-left off fw-bold"> <img class="mx-2 fw-bold"
        ...
        <a href="/ONECAMHI-DIWATA/ONE-CAMHI-USB/HTMLPage/Postarchived.php"
            class="btn kulay text-white float-left fw-bold"> <img class="mx-2"
      ...
      <p class="text-center">
        Note: On this page, you will see the deleted post in the home page.
      </p>
        <br><br><br>
        ...
        <template id="temp">
            ...
            <div class="container mt-2 d-flex flex-row">
                ...
                <div class="d-flex flex-column">
                    <button class="btn d-none btn-danger deletebtn m-2" value="">Delete</button>
                </div>
